...
<div class="row mt-5">
    ...
    <div class="col-md-4">
        <div class="dashboard-card">
            <h4>⚡ Recomendaciones Energía</h4>
            <p>Administra los consejos para el consumo eléctrico.</p>

            <a href="recomendaciones.php?tipo=energia"
    ...
    <div class="col-md-4">
        <div class="dashboard-card">
            <h4>💧 Recomendaciones Agua</h4>
            <p>Administra los consejos para el consumo de agua.</p>

            <a href="recomendaciones.php?tipo=agua"
    ...
    <div class="col-md-4">
        <div class="dashboard-card">
            <h4>🔥 Recomendaciones Gas</h4>
            <p>Administra los consejos para el consumo de gas.</p>

            <a href="recomendaciones.php?tipo=gas"
